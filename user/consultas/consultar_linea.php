...
echo'<table align="center" CELLPADDING="12" CELLSPACING="12" valign="middle" class="tabla_ordenes">
	   <tr>
	   <th class=""><h2>ID Linea</h2></th>
       <th class=""><h2>Linea</h2></th>
	   <th class=""><h2>Tipo de Envase</h2></th>
	   <th class=""><h2>Envase Producido</h2></th>
	   <th class=""><h2>Capacidad x Hora</h2></th>
	   <th class=""><h2>Capacidad x Dia</h2></th>
	   <th class=""><h2>Estatus</h2></th>
	   </tr>';


include('conexion_mysql.php');

$consulta=mysql_query("SELECT  * FROM linea_de_pro");
